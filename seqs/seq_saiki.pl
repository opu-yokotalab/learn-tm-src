...
next([saiki_zenka,saiki_fibo],[[msg,"難易度の高い方の教材を選択しています。えらいですね。"]]):-currentLevel(L),4<=L,L<=5.
next([saiki_zenka,saiki_fibo],[[msg,"自信があれば難易度の高い方にも挑戦してみましょう。"]]):-currentLevel(L),1<=L,L<=3.
...
next([saiki_test,saiki_intro],[[changeLv,1],[msg,"理解がいま一つのようです。最初からやり直してください。"]]):-testCompare(test_saiki,Point),Point<60.
